@echo off
REM
REM summary: Installation script for the OOTyW_fr-FR software package.
REM 
...
set _user=%USERPROFILE%\%_OpenOffice4_Userprofile%
set _ext=OOTyW-A_fr-FR-%_release%.oxt
...
echo -----------------------------------------------------------------
echo #
echo # Installation of OOTyW_fr-FR v%_release% finished.
echo #
echo -----------------------------------------------------------------
pause
