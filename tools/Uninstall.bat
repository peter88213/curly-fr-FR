@echo off
REM
REM summary: Removes the OOTyW_fr-FR software package.
REM 
...
echo -----------------------------------------------------------------
echo OOTyW_fr-FR (OpenOffice typography tools for yWriter users) v%_release%
...
set _ext=OOTyW_fr-FR-A-%_release%.oxt
...
set _ext=OOTyW_fr-FR-%_release%.oxt
...
set _ext=OOTyW_fr-FR-L-%_release%.oxt
...
echo -----------------------------------------------------------------
echo #
echo # OOTyW_fr-FR v%_release% is removed from your PC.
echo #
echo -----------------------------------------------------------------
pause
